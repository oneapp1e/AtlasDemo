...
import bm.hd.mlr.host.update.Updater;
...
public class AtlasActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.open_firstBundle).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Log.e("firstbundle", "0000000");
                Intent intent = new Intent();
                intent.setClassName(AtlasActivity.this, "bm.hd.mlr.firstbundle.FirstActivity");
        ...
        findViewById(R.id.uninstall_firstBundle).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    ...
                    Toast.makeText(AtlasActivity.this, " 远程bundle 卸载失败，" + e.getMessage(), Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
        ...
        findViewById(R.id.open_secondBundle).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClassName(AtlasActivity.this, "bm.hd.mlr.secondbundle.SecondActivity");
                startActivity(intent);
            }
        });
        ...
        findViewById(R.id.uninstall_secondBundle).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(AtlasActivity.this, " 远程 secondbundle 卸载失败，" + e.getMessage(), Toast.LENGTH_LONG).show();
                    e.printStackTrace();
                }
